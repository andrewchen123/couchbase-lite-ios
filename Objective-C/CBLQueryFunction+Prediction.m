...
- (instancetype) initWithModel: (CBLQueryExpression*)model input: (CBLQueryExpression*)input;
...
+ (CBLQueryPredictionFunction*) predictionUsingModel: (CBLQueryExpression*)model
...
+ (CBLQueryExpression*) euclideanDistanceBetween: (CBLQueryExpression*)expression1
                                          ...
                                          weight: (nullable CBLQueryExpression*)weight
{
    CBLAssertNotNil(expression1);
    CBLAssertNotNil(expression2);
    
    NSArray* params = weight != nil ? @[expression1, expression2, weight] :
                                          ...
                                          and: (CBLQueryExpression*)expression2
{
    ...
    NSArray* params = @[expression1, expression2];
    return [[CBLFunctionExpression alloc] initWithFunction: @"COSINE_DISTANCE()"
                                                    params: params];
}
